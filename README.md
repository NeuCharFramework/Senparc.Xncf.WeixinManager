...
XNCF 模块：盛派官方发布的微信管理后台


使用此插件可以在 [NeuCharFramework（NCF）](https://github.com/SenparcCoreFramework/NCF) 中快速集成微信公众号、小程序的`部分`基础管理功能，欢迎大家一起扩展！
